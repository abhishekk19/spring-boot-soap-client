 ...
 *         &lt;element name="P_ACC_ID" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
@XmlRootElement(name = "GetResultReport")
public class GetResultReport {

    @XmlElement(name = "P_CITY")
    protected String pcity;
    @XmlElement(name = "P_ACC_ID")
    protected String paccid;
    ...
    /**
     * Gets the value of the paccid property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the paccid property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setPACCID(String value) {
        this.paccid = value;
    }
